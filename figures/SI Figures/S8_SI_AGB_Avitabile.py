...
class Single_Model_Avitabile_Deviation(BaseAnalysis):
    pass
    ...
    def __init__(self, setup):
        ...
        biomassDataRaw = pd.read_csv(r'/Users/pp/Dropbox/UNI/Projekte/A03_Hydraulics_Implementation/Avitabile/AvitabilieStationAGB.tsv',
                                     sep='\t',
                                     header=None).values
        ...
        for yoi in yois:
            ...
            agb_m_hyd = agb_m_hyd[:, indexes]
            agb_m_std = agb_m_std[indexes]
            agb_vod_ab =  biomassDataRaw[:, 2]  * 10.0
            ...
            for j in range(0, 2):
                ...
                if j == 0:
                    ...
                    axGeo.scatter(data[0], data[1], c = 'tab:blue', alpha =0.3, s = 5)
                ...
                axGeo.set_xlabel("Inventory based AGB [MgC $\mathrm{ha}^{-1}$]")
        ...
        plt.savefig(setup.folderPath + "/" + "Scatter_SI_AGB_Avitabile_MODEL_Deviation.png", dpi=300, bbox_inches='tight',
                    pad_inches=0)
        plt.close()
