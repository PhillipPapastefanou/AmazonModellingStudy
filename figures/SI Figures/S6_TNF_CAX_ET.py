...
class FigureS_TNF_CAX_ET_MONTHLY(BaseAnalysis):
    ...
    def __init__(self, setup):
        ...
        obs_k34 =pd.read_csv('/Users/pp/Documents/AET_K34.csv', sep=',',
            header=None).values

        obs_K67 = pd.read_csv('/Users/pp/Documents/AET_K67.csv', sep=',',
            header=None).values

        for var in ['evapotranspiration']:
        ...
        #for var in listAnalysis[0].stratifiedOutput.PftNames():
            ...
            for d in range(0, 1):
                data_first.append(listAnalysis[d].GetDataSlicesPatchYear(var, 1996))
                data_range.append(listAnalysis[d].GetDataPatchRange(var, 1996, 2010))
            ...
            for gc in range(0, 2):
                ...
                ax.set_ylabel("Evapotranspiration [mm $\mathrm{month}^{-1}$]")
                ...
                #if (gc == 0):
                    #ax.plot(obs_K67[0:42,0], obs_K67[0:42,1], c = 'black')
                    #ax.plot(obs_K67[43:,0], obs_K67[43:,1], c = 'black')
                if (gc == 2):
                    ax.plot(obs_k34[2:24,0], obs_k34[2:24,1], c = 'black')
                    ax.plot(obs_k34[24:,0], obs_k34[24:,1], c = 'black')
